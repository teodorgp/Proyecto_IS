...
//Es un modelo HAY QUE CAMBIAR TODO
...
int menuAdministrativo()//Función que imprime el menú de los administrativos
{
   ...
   clear();
      ...
      cout<<"|__________________________________________________________|\n";
      cout<<"|                                                          |\n";
      cout<<"|Pulsa 1 para acceder a la gestión de los cursos           |\n";
      cout<<"|Pulsa 2 para acceder a la gestión de los paticipantes     |\n";
      cout<<"|Pulsa 3 para acceder a la gestión de las materiales       |\n";
      cout<<"|Pulsa 4 para acceder a la gestión de los coordinadores    |\n";
...
int menuMonitor()//Función que imprime el menú de los monitores
{
   ...
   clear();
      ...
      cout<<"|                                                     |\n";
      cout<<"|-----------------  Menú de Coordinador de Cursos: -----------------|\n";
      cout<<"|_____________________________________________________|\n";
      cout<<"|                                                     |\n";
